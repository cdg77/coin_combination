...
describe('Fixnum#coin_combination') do
  it ('it makes change to pennies only') do
    expect((4).coin_combination()).to(eq('4 pennies, 0 nickles, 0 dimes'))
  end

  it ('it makes change to nickles and pennies') do
    expect((9).coin_combination()).to(eq("4 pennies, 1 nickles, 0 dimes"))
  end

  it ('it makes change to dimes, nickles, and pennies') do
    expect((16).coin_combination()).to(eq("1 pennies, 1 nickles, 1 dimes"))
  end
end
